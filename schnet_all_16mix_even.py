...
from data_model_utils import (
    ...
    gemnet_oc_onehot_inmag_even,
    gemnet_oc_onehot_inmag_even2,
    schnet_onehot_inmag_even,
    schnet_onehot_inmag_even2,
    schnet_onehot_inmag_even3
...
if __name__ == "__main__":
    ...
    file_name="schnet_onehot_inmag_all_optimizer_1000epoch_nopositive_noconstrain_0.1"
    wandb_logger = WandbLogger(project="magmom_paper_new_final",
                                # id  = "3aw7wfxc" ,
                                # resume = "must",
                                name=file_name)
    ...
    num_nodes = 1
    fast_dev_run= False
    model = schnet_onehot_inmag_even3
    data_path = "chgnet_Elabel_inmag_88"
    batch_size =  128 #!16 
    num_workers =  8
    energy_w = 1
    magmom_w = 1
