...
if __name__ == "__main__":
    ...
    file_name= "gemnet_onehot_inmag_all_16mix_optimizer"
    ...
    if retrain:
        ...
        checkpoint = "/pscratch/sd/w/wenxu/jobs/OCP/github_rep/ocp_mag_chgnet_paper_new/magmom_checkpoints/gemnet_onehot_inmag_all_16mix_optimizer-epoch=627-step=366744-val_loss=0.0223-last.ckpt"
