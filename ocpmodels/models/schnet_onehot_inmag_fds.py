...
@registry.register_model("schnet_onehot_inmag_fds")
...
#!>>>>>move to 
    ...
    def forward(self, data): #!wx fds
        ...
        if self.use_pbc:
            ...
            _batch = torch.zeros_like(z) if batch is None else batch

            return h_E, h_M, _batch
