...
@registry.register_model("gemnet_oc_onehot_inmag_emb")
class GemNetOC(BaseModel):
    ...
    def subselect_edges(
        ...
        #有没有可能是下面的get_max_neighbors_mask返回的subgroup neighbors =0
    ...
    def generate_graph_dict(self, data, cutoff, max_neighbors):
        ...
        #!graph is from base, generate_graph func.
    ...
    def forward(self, data):
        ...
        if self.regress_forces:
            ...
            E_t = E_t.squeeze(1)  # (num_molecules)
            return E_t, M_pred, _h, E_peratom # YURI: for joint loss predictions
    @property
