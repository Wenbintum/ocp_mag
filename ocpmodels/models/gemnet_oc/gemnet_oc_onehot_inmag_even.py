...
@registry.register_model("gemnet_oc_onehot_inmag_even")
class GemNetOC(BaseModel):
    ...
    def forward(self, data):
        ...
        if self.regress_forces:
            ...
            M_pred_vec = torch.where(data.tmp != 0, M_pred * data.tmp, M_pred)
            return E_t, M_pred_vec # YURI: for joint loss predictions #! wxeven
